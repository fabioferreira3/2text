...
class PromptHelper
{
    ...
    public function writeOutline($context, $maxSubtopics, $tone = 'casual')
    {
        ...
        switch ($this->language) {
            case 'en':
                return "Create an indept and comprehensive blog post outline, with maximum of two levels, using roman numerals indicating main topics and alphabet letters to indicate subtopics. The outline must have only $maxSubtopics topics. The outline must have a " . $tone . " tone. The outline must have a concluding topic in the end. Do not nest a third level of topics. Do not add inner topics inside the subtopics indicated by alphabet letters, for example: \n\nGood output:\nI. Main Topic \n A. Subtopic 1 \n B. Subtopic 2 \n C. Subtopic 3 \n\nBad output:\nI. Main Topic \nA. Subtopic 1 \nB. Subtopic 2\n   1. Inner topic 1\n   2. Inner topic 2\nC. Subtopic 3\n\n\n The outline should be based on the following text: \n\n" . $context;
            case 'pt':
                return "Crie um esboço de postagem de blog aprofundado e abrangente, com no máximo dois níveis, com um tom " . $tone . ", usando números romanos para indicar os tópicos principais e letras do alfabeto comum para indicar subtópicos. O esboço deve ter somente $maxSubtopics tópicos. O esboço precisa ter um tópico de conclusão no final. Não adicione um terceiro nível de tópicos. Não adicione tópicos internos dentro dos subtópicos indicados com letras do alfabeto comum, por exemplo: \n\nOutput correto:\nI. Tópico Principal \n A. Sub-tópico 1 \n B. Sub-tópico 2 \n C. Sub-tópico 3 \n\nOutput errado:\nI. Tópico Principal \nA. Sub-tópico 1 \nB. Sub-tópico 2\n   1. Sub-tópico interno 1\n   2. Sub-tópico interno 2\nC. Sub-tópico 3\n\n\n O esboço deve ser baseado no seguinte texto: \n\n" . $context;
            case 'es':
                return "Crea un esquema de publicación de blog profundo y completo, con un máximo de dos niveles, con un tono " . $tone . ", usando números romanos para indicar los temas principales y letras del alfabeto común para indicar subtemas. El esquema debe tener solamente $maxSubtopics temas. El esquema debe tener un tema de cierre al final. No agregues un tercer nivel de temas. No agregues temas internos dentro de los subtemas indicados con letras del alfabeto común, por ejemplo: \n\nOutput correcto:\nI. Tema Principal \n A. Subtema 1 \n B. Subtema 2 \n C. Subtema 3 \n\nOutput incorrecto:\nI. Tema Principal \nA. Subtema 1 \nB. Subtema 2\n   1. Subtema interno 1\n   2. Subtema interno 2\nC. Subtema 3\n\n\n El esquema debe ser basado en el siguiente texto: \n\n" . $context;
            case 'fr':
                return "Créez un plan de publication de blog approfondi et complet, avec un maximum de deux niveaux, avec un ton " . $tone . ", en utilisant des chiffres romains pour indiquer les sujets principaux et des lettres de l'alphabet commun pour indiquer les sous-sujets. Le plan doit avoir seulement $maxSubtopics sujets. Le plan doit avoir un sujet de clôture à la fin. N'ajoutez pas un troisième niveau de sujets. N'ajoutez pas de sujets internes dans les sous-sujets indiqués par des lettres de l'alphabet commun, par exemple: \n\nOutput correct:\nI. Sujet Principal \n A. Sous-sujet 1 \n B. Sous-sujet 2 \n C. Sous-sujet 3 \n\nOutput incorrect:\nI. Sujet Principal \nA. Sous-sujet 1 \nB. Sous-sujet 2\n   1. Sous-sujet interne 1\n   2. Sous-sujet interne 2\nC. Sous-sujet 3\n\n\n Le plan doit être basé sur le texte suivant: \n\n" . $context;
            case 'de':
                return "Erstellen Sie eine umfassende und umfassende Blog-Post-Gliederung mit maximal zwei Ebenen und einem " . $tone . "-Ton, indem Sie römische Zahlen verwenden, um Hauptthemen und Buchstaben des allgemeinen Alphabets zu verwenden, um Unterthemen anzuzeigen. Die Gliederung darf nur $maxSubtopics Themen haben. Die Gliederung muss am Ende ein Schlussthema haben. Fügen Sie keine dritte Ebene von Themen ein. Fügen Sie keine inneren Themen in die mit Buchstaben des allgemeinen Alphabets angegebenen Unterthemen ein, zum Beispiel: \n\nGutes Ergebnis:\nI. Hauptthema \n A. Unterthema 1 \n B. Unterthema 2 \n C. Unterthema 3 \n\nSchlechtes Ergebnis:\nI. Hauptthema \nA. Unterthema 1 \nB. Unterthema 2\n   1. Inneres Thema 1\n   2. Inneres Thema 2\nC. Unterthema 3\n\n\n Die Gliederung sollte auf dem folgenden Text basieren: \n\n" . $context;
            case 'it':
                return "Crea un piano di pubblicazione del blog approfondito e completo, con un massimo di due livelli, con un tono " . $tone . ", usando numeri romani per indicare gli argomenti principali e lettere dell'alfabeto comune per indicare i sottoargomenti. Il piano deve avere solo $maxSubtopics argomenti. Lo schema deve avere un argomento di chiusura alla fine. Non aggiungere un terzo livello di argomenti. Non aggiungere argomenti interni nei sottoargomenti indicati con lettere dell'alfabeto comune, ad esempio: \n\nOutput corretto:\nI. Argomento principale \n A. Sotto-argomento 1 \n B. Sotto-argomento 2 \n C. Sotto-argomento 3 \n\nOutput errato:\nI. Argomento principale \nA. Sotto-argomento 1 \nB. Sotto-argomento 2\n   1. Sotto-argomento interno 1\n   2. Sotto-argomento interno 2\nC. Sotto-argomento 3\n\n\n Il piano deve essere basato sul seguente testo: \n\n" . $context;
            case 'ru':
                return "Создайте подробный и полный план публикации блога с максимумом двух уровней, с тональностью " . $tone . ", используя римские цифры для обозначения основных тем и букв общего алфавита для обозначения подтем. План должен иметь только $maxSubtopics тем. План должен иметь закрывающую тему в конце. Не добавляйте третий уровень тем. Не добавляйте внутренние темы в подтемы, указанные буквами общего алфавита, например: \n\nПравильный вывод:\nI. Основная тема \n A. Подтема 1 \n B. Подтема 2 \n C. Подтема 3 \n\nНеправильный вывод:\nI. Основная тема \nA. Подтема 1 \nB. Подтема 2\n   1. Внутренняя тема 1\n   2. Внутренняя тема 2\nC. Подтема 3\n\n\n План должен быть основан на следующем тексте: \n\n" . $context;
            case 'ja':
                return "最大2レベルで、" . $tone . " のトーンを使用して、主題を示すためにローマ数字を使用し、サブトピックを示すために一般的なアルファベットの文字を使用して、包括的で包括的なブログ投稿のアウトラインを作成します。計画には、$maxSubtopics トピックのみが含まれています。アウトラインの最後には締めのトピックが必要です。トピックの3番目のレベルを追加しないでください。一般的なアルファベットの文字で指定されたサブトピックに内部トピックを追加しないでください。例：\n\n正しい出力：\nI.メインテーマ \n A.サブトピック1 \n B.サブトピック2 \n C.サブトピック3 \n\n間違った出力：\nI.メインテーマ \nA.サブトピック1 \nB.サブトピック2\n   1.内部トピック1\n   2.内部トピック2\nC.サブトピック3\n\n\n この計画は、次のテキストに基づいています。\n\n" . $context;
            case 'ch':
                return "使用罗马数字表示主题，使用通用字母表示子主题，使用 " . $tone . " 的语气，创建一个详细而全面的博客发布大纲，最多有两个级别。计划只包含$maxSubtopics 个主题。大纲末尾必须有一个结束主题。不要添加第三个级别的主题。不要在用通用字母指定的子主题中添加内部主题。例如：\n\n正确的输出：\nI.主题 \n A.子主题1 \n B.子主题2 \n C.子主题3 \n\n错误的输出：\nI.主题 \nA.子主题1 \nB.子主题2\n   1.内部主题1\n   2.内部主题2\nC.子主题3\n\n\n 该计划应基于以下文本：\n\n" . $context;
            case 'ar':
            ...
            case 'ko':
                return "로마 숫자를 사용하여 주제를 나타내고 일반적인 알파벳 문자를 사용하여 하위 주제를 나타내며 " . $tone . " 톤을 사용하여 자세하고 포괄적 인 블로그 게시물 개요를 만듭니다. 최대 2 레벨. 계획에는 $maxSubtopics 개의 주제 만 포함됩니다. 개요는 끝에 마무리 주제가 있어야 합니다. 주제의 세 번째 수준을 추가하지 마십시오. 일반적인 알파벳 문자로 지정된 하위 주제에 내부 주제를 추가하지 마십시오. 예 :\n\n올바른 출력 :\nI. 메인 주제 \n A. 하위 주제 1 \n B. 하위 주제 2 \n C. 하위 주제 3 \n\n잘못된 출력 :\nI. 메인 주제 \nA. 하위 주제 1 \nB. 하위 주제 2\n   1. 내부 주제 1\n   2. 내부 주제 2\nC. 하위 주제 3\n\n\n이 계획은 다음 텍스트를 기반으로합니다. \n\n" . $context;
            case 'tr':
                return "Ana konuları göstermek için Roma rakamlarını, alt konuları göstermek için genel harfleri ve " . $tone . " tonunu kullanarak ayrıntılı ve kapsamlı bir blog yayını taslağı oluşturun. En fazla 2 seviye. Plan, yalnızca $maxSubtopics konuyu içermelidir. Taslağın sonunda bir kapanış konusu olmalıdır. Konuların üçüncü seviyesini eklemeyin. Genel harflerle belirtilen alt konularda iç konular eklemeyin. Örnek :\n\nDoğru çıktı :\nI. Ana konu \n A. Alt konu 1 \n B. Alt konu 2 \n C. Alt konu 3 \n\nYanlış çıktı :\nI. Ana konu \nA. Alt konu 1 \nB. Alt konu 2\n   1. İç konu 1\n   2. İç konu 2\nC. Alt konu 3\n\n\nBu plan aşağıdaki metne dayanmalıdır. \n\n" . $context;
            case 'pl':
                return "Utwórz szczegółowy i wszechstronny szkic posta na blogu, używając cyfr rzymskich do wskazania tematów głównych, ogólnych liter do wskazania tematów podrzędnych i " . $tone . " tonu. Maksymalnie 2 poziomy. Plan powinien zawierać tylko $maxSubtopics tematów. Konspekt musi mieć na końcu temat zamykający. Nie dodawaj trzeciego poziomu tematów. Nie dodawaj tematów wewnętrznych w tematach podrzędnych wskazanych ogólnymi literami. Przykład :\n\nPoprawny wynik :\nI. Temat główny \n A. Temat podrzędny 1 \n B. Temat podrzędny 2 \n C. Temat podrzędny 3 \n\nNiepoprawny wynik :\nI. Temat główny \nA. Temat podrzędny 1 \nB. Temat podrzędny 2\n   1. Temat wewnętrzny 1\n   2. Temat wewnętrzny 2\nC. Temat podrzędny 3\n\n\nTen plan powinien być oparty na następującym tekście. \n\n" . $context;
            case 'el':
                return "Δημιουργήστε ένα εκτενές σκιαγράφημα άρθρου ιστολογίου, με το πολύ δύο επίπεδα, με τόνο " . $tone . ", χρησιμοποιώντας ρωμαϊκούς αριθμούς για τα κύρια θέματα και γράμματα του αλφαβήτου για τα υπο-θέματα. Το σκιαγράφημα πρέπει να έχει μόνο $maxSubtopics θέματα. Το περίγραμμα πρέπει να έχει ένα θέμα κλεισίματος στο τέλος. Μην κάνετε ενσωμάτωση ενός τρίτου επιπέδου θεμάτων. Μην προσθέτετε εσωτερικά θέματα μέσα στα υπο-θέματα που υποδεικνύονται από τα γράμματα του αλφαβήτου, για παράδειγμα: \n\nΚαλή Έξοδος:\nI. Κύριο Θέμα \n A. Υπο-θέμα 1 \n B. Υπο-θέμα 2 \n C. Υπο-θέμα 3 \n\nΚακή Έξοδος:\nI. Κύριο Θέμα \nA. Υπο-θέμα 1 \nB. Υπο-θέμα 2\n 1. Εσωτερικό θέμα 1\n 2. Εσωτερικό θέμα 2\nC. Υπο-θέμα 3\n\n\n Το σκιαγράφημα πρέπει να βασίζεται στον ακόλουθο κείμενο: \n\n" . $context;
            default:
                return '';
        }
    }
