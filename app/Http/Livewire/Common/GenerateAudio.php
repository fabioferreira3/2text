...
class GenerateAudio extends Component
{
    ...
    public function mount(Document $document, $language = null)
    {
        ...
        $this->currentAudioUrl = ($this->document->meta['audio_file'] ?? false) ? $this->getAudioUrl($this->document->meta['audio_file']) : null;
    ...
    public function ready($params)
    {
        ...
        if ($params['document_id'] === $this->document->id) {
            ...
            $this->currentAudioUrl = $this->getAudioUrl($this->currentAudioFile);
        }
