<div class="flex flex-col g-white rounded-lg grow h-full">
    ...
    <div class="flex items-center justify-between gap-8">
        ...
        <div class="w-1/2">
            <div class="text-right text-gray-600">{{__('text-to-audio.page_info')}}</div>
        </div>
    </div>
    @endsection
        ...
        <div class="flex flex-col md:flex-row gap-8 bg-white p-8 rounded-lg h-full">
            ...
            <div class="flex flex-col gap-4 w-full md:w-1/2">
                ...
                <div class="flex flex-col overflow-auto h-[1px] grow">
                    ...
                    <div class="{{$selectedVoice === $voice['id'] ? 'bg-gray-200' : ''}} flex items-center justify-between px-4 py-2 border border-t-0 border-x-0 border-b">
                        ...
                        <div wire:click="playAudio('{{$voice['id']}}')" class="flex items-center gap-1 border border-gray-200 bg-gray-100 px-3 py-1 rounded-lg cursor-pointer hover:bg-main group">
                            <x-icon solid name="play" width="40" height="40" class="text-zinc-500 group-hover:text-white" />
