            ...
            <div class="flex flex-col md:grid md:grid-cols-2 gap-6 mt-2">
                        ...
                        <div>
                            ...
                            <div class='grid grid-cols-2 gap-8 mt-2'>
                                <div class='flex flex-col gap-2'>
                                    <x-checkbox md id="facebook" name="facebook" label="Facebook" wire:model="platforms.Facebook" />
                                    <x-checkbox md id="instagram" name="instagram" label="Instagram" wire:model="platforms.Instagram" />
                                    <x-checkbox md id="twitter" name="twitter" label="X (former Twitter)" wire:model="platforms.Twitter" />
                                </div>
                                <div class='flex flex-col gap-2'>
                                    <x-checkbox md id="linkedin" name="linkedin" label="Linkedin" wire:model="platforms.Linkedin" />
                                </div>
                            </div>
                            <div class="mt-2">
                    ...
                    <div class="flex flex-col gap-6">
                        ...
                        <div class="flex flex-col md:grid md:grid-cols-2 gap-6">
                            <div class="flex flex-col gap-3">
                                ...
                                <select name="provider" wire:model.live="sourceType" class="p-3 rounded-lg border border-zinc-200 w-full">
                            ...
                            <div class="flex flex-col gap-3">
                                ...
                                <input type="number" name="word_count_target" wire:model="wordCountTarget" class="p-3 border border-zinc-200 rounded-lg w-full" />
                        ...
                        <div>
                            ...
                            <div>
                                ...
                                <textarea class="border border-zinc-200 rounded-lg w-full mt-3" rows="6" maxlength="30000" wire:model="context"></textarea>
                                <div class="mt-2">
                            ...
                            <input type="file" name="fileInput" wire:model.live="fileInput" class="p-3 border border-zinc-200 rounded-lg w-full" />
                            @endif
                            ...
                            <label class="font-bold text-lg text-zinc-700 flex items-center justify-between">
                                @if($sourceType === 'youtube') {{ __('social_media.youtube_option') }} <span class="text-sm">{{__('social_media.max_permitted_youtube_links', ['max'
                                    => 3])}}</span>
                            ...
                            <div class="flex items-center gap-2" x-data="{
                                ...
                                <input name="url" x-on:keydown.enter="handleEnter($event)" wire:model="tempSourceUrl" class="p-3 border border-zinc-200 rounded-lg w-full" />
                ...
                <div class="w-full flex flex-col gap-6">
                    <div class="flex flex-col gap-3">
                        <div class="flex flex-col gap-4 border rounded-xl p-4">
                            ...
                            <div class="flex flex-col mt-2">
                                ...
                                <textarea placeholder="{{__('social_media.placeholder_example')}}" class="border border-zinc-200 rounded-lg w-full mt-3" rows="3" maxlength="1000" wire:model="imgPrompt"></textarea>
                                <div class="mt-2">
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        <select name="style" wire:model.live="style" class="p-3 rounded-lg border border-zinc-200 focus:border focus:border-zinc-400">
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        <select name="tone" wire:model.live="tone" class="p-3 rounded-lg border border-zinc-200 focus:border focus:border-zinc-400">
