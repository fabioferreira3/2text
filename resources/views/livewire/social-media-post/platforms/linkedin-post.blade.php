        ...
        <div class="flex justify-end">
            <x-dropdown persistent>
                <x-dropdown.item icon="book-open">
                    <x-button sm wire:loading.attr="disabled" wire:click='showHistoryModal'
                ...
                <x-dropdown.item icon="clipboard-copy" separator>
                    <x-button sm wire:loading.attr="disabled" wire:click='copy' :label="$copied ? __('common.copied') : __('common.copy')"
                        class='hover:bg-transparent hover:shadow-none border-0 px-0 text-zinc-700' />
                </x-dropdown.item>
