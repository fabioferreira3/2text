    ...
    <div class="flex flex-col gap-6">
        @if($document->meta['Linkedin'] ?? false)
            <div class="accordion-item">
                <div onclick="toggleAccordion(this)" class='h-20 flex items-center bg-white rounded-t-lg border border-zinc-200 px-4 py-2 cursor-pointer accordion-header'>
                    <img class="h-8" src="{{ Vite::asset('resources/images/linkedin-logo.png') }}">
                </div>
                <div class='accordion-content overflow-hidden transition-all duration-300 ease-in-out p-8  border border-zinc-200 bg-[#006193] rounded-b-lg'>
        ...
        @if($document->meta['Twitter'] ?? false)
            <div class="accordion-item">
                ...
                <div class='accordion-content overflow-hidden transition-all duration-300 ease-in-out p-8  border border-zinc-200 bg-[#1DA1F2] rounded-b-lg'>
        ...
        @if($document->meta['Instagram'] ?? false)
            <div class="accordion-item">
                ...
                <div class='accordion-content overflow-hidden transition-all duration-300 ease-in-out p-8  border border-zinc-200 bg-[#B92A70] rounded-b-lg'>
                @livewire('social-media-post.post', [$document, 'Twitter', 'rows' => 6])
                </div>
            </div>
        @endif
