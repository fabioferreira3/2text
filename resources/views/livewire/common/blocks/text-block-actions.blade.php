<div
    ...
    <div class="flex items-center gap-1">
        ...
        <button wire:click="undo"
            class="relative group/button flex items-center text-gray-600 hover:bg-secondary hover:text-white hover:border-white bg-white border border-gray-400 px-3 py-1 rounded-lg transition ease-in-out duration-200">
    ...
    <div class="flex items-center gap-1">
        <button
            class="flex items-center gap-1 text-gray-600 hover:bg-secondary hover:text-white hover:border-white hover:font-bold bg-white border border-gray-400 px-3 py-1 rounded-lg transition-all ease-in-out duration-200"
            wire:click="toggleCustomPrompt">
            <x-icon name="speakerphone" width="18" height="18" />
            <div>Ask to...</div>
        </button>
        <button wire:click="shorten"
            class="flex items-center gap-2 text-gray-600 hover:bg-secondary hover:text-white hover:font-bold hover:border-white bg-white border border-gray-400 px-3 py-1 rounded-lg transition-all ease-in-out duration-200">
            <x-icon name="menu-alt-4" width="18" height="18" />
            <div>shorten</div>
        </button>
        <button wire:click="expand"
            class="flex items-center gap-1 text-gray-600 hover:bg-secondary hover:text-white hover:font-bold hover:border-white bg-white border border-gray-400 px-3 py-1 rounded-lg transition-all ease-in-out duration-200">
            <x-icon name="menu" width="18" height="18" />
            <div>expand</div>
        </button>
        <div
            class="relative group/more flex items-center gap-1 text-gray-600 hover:bg-secondary hover:text-white hover:border-white hover:rounded-br-none hover:rounded-bl-none rounded-lg bg-white border border-gray-400 px-3 py-1 transition-all ease-in-out duration-200">
            <x-icon name="sparkles" width="18" height="18" />
            <div>more</div>
            <div
                class="invisible group-hover/more:visible absolute flex flex-col right-0 bg-white top-full w-[180px] overflow-hidden rounded-tl-lg rounded-b-lg border border-gray-400">
