<div class="flex flex-col gap-6">
    ...
    <div class="w-full flex flex-col items-center justify-between md:flex-row">
        <div><button wire:click="showHistory"
                class="transition-colors ease-in-out duration-500 delay-150 flex items-center justify-center gap-2 bg-zinc-300 border border-zinc-100 hover:bg-zinc-400 hover:text-white py-2 px-3 rounded-lg text-sm text-gray-700 w-full">
