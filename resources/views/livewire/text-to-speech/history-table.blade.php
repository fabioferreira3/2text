<div class="w-full mt-8">
    ...
    <table class="w-full table-auto">
        <thead>
            <tr>
                <th>
                    <div class="bg-gray-200 text-left px-4 py-2 border rounded-lg">{{__('text-to-speech.date')}}
                    </div>
                </th>
                <th>
                    <div class="bg-gray-200 text-left px-4 py-2 border rounded-lg">{{__('text-to-speech.content')}}
                    </div>
                </th>
                <th>
                    <div class="bg-gray-200 text-left px-4 py-2 border rounded-lg">{{__('text-to-speech.voice')}}
                    </div>
                </th>
                <th>
                    <div class="bg-gray-200 text-left px-4 py-2 border rounded-lg">{{__('text-to-speech.actions')}}
                    </div>
                </th>
            </tr>
        </thead>
