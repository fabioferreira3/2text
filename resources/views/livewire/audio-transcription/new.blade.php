        ...
        <div class="col-span-3">
            <div class="flex flex-col gap-6 p-4 border-zinc-200 border rounded-lg bg-white">
                ...
                <div class="grid grid-cols-3 gap-6">
                    <div class="flex flex-col gap-3">
                        <div class="flex gap-2 items-center">
                            <label class="text-xl font-bold text-gray-700">{{__('transcription.identify_speakers')}}?</label>
                        ...
                        <div>
                            <x-checkbox md id="identify_speakers" name="identify_speakers" label="{{__('common.yes')}}" wire:model="identify_speakers" />
                        </div>
                    </div>
                    <div class="flex flex-col gap-3">
                        <div class="flex gap-2 items-center">
                            <label class="text-xl font-bold text-gray-700">{{__('transcription.speakers_expected')}}:</label>
                        ...
                        <div>
                            <input type="number" min="1" max="10" class="w-1/3 p-3 border border-zinc-200 rounded-lg" wire:model="speakers_expected" />
                        </div>
                    </div>
                </div>
                <div class="flex justify-center mt-4">
                    <button wire:click="process" wire:loading.remove class="bg-secondary text-xl hover:bg-main text-white font-bold px-4 py-2 rounded-lg">
