        ...
        <div class="flex flex-col gap-6 p-4 border rounded-lg">
            ...
            <div class="w-1/2">
                ...
                <label class="font-bold text-xl text-zinc-700 flex items-center gap-3">
                    @if($source === 'youtube') {{ __('blog.youtube_option') }} <span class="text-base">{{__('blog.max_permitted_youtube_links', ['max'
                            => 3])}}</span>
                ...
                <div class="flex items-center gap-2" x-data="{
                    ...
                    <input name="url" placeholder="Paste a url here" x-on:keydown.enter="handleEnter($event)" wire:model.defer="tempSourceUrl" class="p-3 border border-zinc-200 rounded-lg w-full" />
