<div>
    <div class="flex flex-col gap-12 justify-center items-center w-full md:w-2/3 mx-auto">
    ...
    <div class="px-4 2xl:w-2/3 mx-auto mt-12">
        <div class="text-center text-xl font-thin">{{__('checkout.save_by_subscribing')}}</div>
        <div class="flex flex-col lg:grid lg:grid-cols-3 gap-4 mt-12">
