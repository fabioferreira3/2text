<div class="flex flex-col gap-6">
    ...
    'document' => $document,
    'editable' => true,
    'render_actions' => 'inquiry-hub.new-button'
    ])
    ...
    <div class="flex gap-4">
        <div class="w-full md:w-2/5">
            ...
            <div class="mt-6">
                <div class="w-full flex flex-col gap-6">
                    ...
                    @if(!$isProcessing)
                    <div class="flex mt-4">
                        <button wire:click="embed" wire:loading.remove class="bg-secondary text-white rounded-lg py-2 px-4 font-bold text-xl">
        ...
        <div class="w-full md:w-3/5 border max-h-[32rem] rounded-lg p-4 bg-gray-100">
            @if ($hasEmbeddings) <div class="flex flex-col justify-end gap-2 h-full">
                ...
                <div class="w-full flex flex-col justify-end" x-data="{
                    ...
                    <button @if($isProcessing) disabled @endif wire:click='submitMsg' class="bg-secondary text-white py-1 rounded-b-lg font-bold text-lg">{{__('inquiry-hub.send')}}</button>
                </div>
                @endif
