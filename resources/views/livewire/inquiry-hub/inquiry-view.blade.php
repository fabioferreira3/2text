<div class="flex flex-col gap-6">
    <div class="flex items-center justify-between">
        ...
        <div class="flex items-center gap-2">
            <button wire:click="createNewInquiry()" class="flex items-center gap-1 bg-main text-white font-bold px-3 py-1 rounded-lg">
            ...
            <div class="mt-6">
                <div class="w-full flex flex-col gap-6">
                    ...
                    <div class="w-full flex justify-center">
                        <button class="bg-secondary text-white rounded-lg py-2 px-4 font-bold text-xl">{{__('inquiry-hub.submit')}}</button>
                    </div>
                </div>
            </div>
        </div>
        <div class="w-full md:w-1/2 border rounded-lg p-4 h-[450px] bg-gray-100">
            <div class="flex flex-col justify-end gap-2 h-full">
                <div id="inquiryChatContainer" class="flex-grow flex flex-col overflow-y-auto bg-white rounded-lg border-gray-200 border pt-6">
