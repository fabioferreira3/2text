<div class="flex items-center gap-4">
    <div class="md:hidden flex items-center gap-4 justify-between w-full">
        ...
        <select name="language" wire:model="tone" class="appearance-none w-64 rounded-lg border border-zinc-200">
    ...
    <div class="hidden md:flex items-center gap-4">
        ...
        <button wire:click="setTone('default')" class="duration-500 rounded-full text-sm px-4 py-1 hover:bg-main hover:text-white hover:font-bold {{$tone === null ? 'bg-main text-white font-bold' : 'bg-zinc-100 text-zinc-700'}}">{{ __('paraphraser.default') }}</button>
