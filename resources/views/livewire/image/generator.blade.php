    ...
    <div class="p-4 h-1/2">
        ...
        <div class="flex flex-col gap-2 w-full mt-8 md:mt-0">
            ...
            <div class="flex flex-col md:grid md:grid-cols-2 gap-4">
                ...
                <div wire:key="{{$key}}" class="relative group border border-gray-200 rounded-lg max-h-96">
    ...
    <div class="flex flex-col md:items-center md:justify-between gap-6 mt-4">
        <div class="flex flex-col gap-2 w-full">
            <div class="flex flex-col gap-2 md:flex-row items-center justify-between">
                ...
                <!-- Image guidelines -->
                <div class="relative w-full md:w-auto place-self-end" x-data="{ open: false }"
        ...
        <div class="flex justify-center items-center gap-2">
            ...
            <input type="number" wire:model.live="samples" class="border border-gray-200 rounded-lg" min="1" max="8" />
        </div>
