<x-guest-layout>
    <x-jet-authentication-card>
        <x-slot name="logo">
            <div class="w-1/3 md:w-1/4 xl:w-1/5 m-auto mb-8">
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="flex justify-between py-6">
                ...
                <a class="font-courier underline text-sm text-gray-600 hover:text-gray-900" href="{{ route('password.request') }}">
            ...
            <div>
                <x-button type="submit" label="Sign in" red class="font-courier font-bold bg-secondary text-xl xl:text-lg w-full text-center rounded-lg" />
            </div>
        </form>
