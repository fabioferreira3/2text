    ...
    <div class="px-4 sm:px-6 flex items-center md:block bg-main sm:bg-white">
        ...
        <div class="flex w-full items-center justify-between h-12">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <div class="font-medium text-gray-500 flex items-center gap-2">My units: <div class="px-4 py-1 bg-gray-200 rounded-lg text-sm font-bold">{{auth()->user()->account->units}}</div>
                </div>
                <!-- Settings Dropdown -->
