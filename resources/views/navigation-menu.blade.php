    ...
    <div class="px-4 sm:px-6 flex items-center md:block bg-main sm:bg-white">
        ...
        <div class="flex w-full items-center justify-between h-12">
            <div class="mr-8 sm:mr-0">
                ...
                <a href="{{url()->previous()}}" class="flex text-white text-sm items-center gap-2 bg-secondary px-4 py-1 rounded-full">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <div class="font-medium text-gray-500 flex items-center gap-2 mr-6">{{__('common.my_units')}}:
                    <div class="px-4 py-1 bg-gray-200 rounded-lg text-sm font-bold">
                        {{number_format(auth()->user()->account->units)}}
                    </div>
                    <div>
                        <a href="{{route('purchase')}}">
                            <x-icon solid class="text-green-500" name="plus-circle" width="24" height="24" />
                        </a>
                    </div>
                </div>
                <!-- Settings Dropdown -->
    ...
    <div class="md:hidden">
        <div :class="{'block bg-white': open, 'hidden': ! open}">
            <div class="pt-2 pb-3 space-y-1">
                ...
                <x-jet-responsive-nav-link href="{{ route('new-audio-transcription') }}" :active="request()->routeIs('new-audio-transcription')">
                ...
                <x-jet-responsive-nav-link href="{{ route('new-text-to-audio') }}" :active="request()->routeIs('new-text-to-audio')">
