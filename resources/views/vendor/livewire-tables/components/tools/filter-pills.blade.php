                ...
                @foreach($component->getAppliedFiltersWithValues() as $filterSelectName => $value)
                    ...
                    @else
                        <span
                            ...
                            class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium leading-4 bg-zinc-100 text-zinc-800 capitalize dark:bg-zinc-200 dark:text-zinc-900"
                        >
                            ...
                            <button
                                ...
                                type="button"
                                class="flex-shrink-0 ml-0.5 h-4 w-4 rounded-full inline-flex items-center justify-center text-zinc-400 hover:bg-zinc-200 hover:text-zinc-500 focus:outline-none focus:bg-zinc-500 focus:text-white"
                            >
