<div x-data="wireui_color_picker({
    ...
    <x-dynamic-component {{ $attributes->except(['class', 'wire:key'])->whereDoesntStartWith('wire:model.live') }}
        ...
        <x-slot name="append">
            <div class="absolute inset-y-0 right-0 flex items-center p-0.5">
                <x-dynamic-component :component="WireUi::component('button')" class="h-full rounded-r-md" primary flat
                    squared x-on:click="toggle" trigger @if($disabled) disabled @endif>
    ...
    <x-wireui::parts.popover :margin="(bool) $label" class="
