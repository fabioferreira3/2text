...
beforeEach(function () {
    ...
    $this->component = actingAs($this->authUser)->livewire(FacebookPost::class, [
...
describe(
    ...
    function () {
        it('renders the facebook post view', function () {
            ...
            $this->component->assertStatus(200)->assertViewIs('livewire.social-media-post.platforms.facebook-post');
        });
    }
)->group('social-media');
