...
return [
    ...
    'write_outline' => "Create an indept and comprehensive blog post outline, with maximum of two levels, using roman numerals indicating main topics and alphabet letters indicating subtopics. The outline must have only :maxsubtopics subtopics, being the last topic the concluding one. The outline must have a :tone tone. Do not nest a third level of topics. Do not add inner topics inside the subtopics indicated by alphabet letters, for example: \n\nGood output:\nI. Main Topic \n A. Subtopic 1 \n B. Subtopic 2 \n C. Subtopic 3 \n\nBad output:\nI. Main Topic \nA. Subtopic 1 \nB. Subtopic 2\n   1. Inner topic 1\n   2. Inner topic 2\nC. Subtopic 3\n\n\n The outline should be based on the following text: \n\n:context",
