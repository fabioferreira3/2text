...
return [
    ...
    'enter_youtube' => 'Enter a youtube link and Oraculum will write text based on the content of the video.',
    'enter_website' => 'Enter an external website url to be used as context, like another blog post or page. Oraculum will do its best to extract as much information as possible from that page and use it as context for the creation of your text.',
    'free_text' => 'Just enter any text that you want as context and Oraculum will write a text based on the information you provide.',
    'file_option' => 'File:',
